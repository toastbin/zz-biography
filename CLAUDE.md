...
- ESLint + OxLint + Prettier (linting/formatting)

## Architecture

Entry point: `src/main.ts` creates Vue app, registers router, mounts to `#app`

Router: `src/router/index.ts` uses `createWebHistory` with empty routes (to be populated)
